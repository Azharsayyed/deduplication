...
public class Chart extends ApplicationFrame{
	...
	static long dedup;
	static String title;
public Chart(String paramString,long n,long d){
	super(paramString);
	normal = n;
	dedup = d;
...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(normal,"Idedup","Idedup");
	localDefaultCategoryDataset.addValue(dedup,"Select Dedup","Select Dedup");
